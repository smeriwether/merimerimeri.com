...
def create_rss_feed
  ...
  rss = RSS::Maker.make("atom") do |maker|
    ...
    maker.channel.about = "https://merimerimeri.com"
    maker.channel.title = "A blog about technology and the internet - https://merimerimeri.com"
    maker.channel.description = "A blog by Stephen Meriwether about technology and the internet."
    maker.channel.link = "https://merimerimeri.com"
    maker.channel.updated = Time.now

    posts.each do |post|
      maker.items.new_item do |item|
        item.link = "https://merimerimeri.com/#{post.slug}"
